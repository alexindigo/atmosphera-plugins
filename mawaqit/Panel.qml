  ...
  Rectangle {
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        AtmoIcon { icon: widgetIcon; pointSize: Style.fontSizeXL; color: Color.mPrimary; Layout.alignment: Qt.AlignVCenter }
      ...
      NTabView {
        ...
        ColumnLayout {
              ...
              Repeater {
                ...
                delegate: Rectangle {
                  ...
                  RowLayout {
                    ...
                    spacing: Style.marginM
                    AtmoIcon { icon: modelData.icon; pointSize: Style.fontSizeM; color: itemColor; Layout.alignment: Qt.AlignVCenter }
          ...
          Item {
            ...
            ColumnLayout {
              ...
              AtmoIcon { icon: widgetIcon; pointSize: Style.fontSizeXXXL; color: Color.mSecondary; Layout.alignment: Qt.AlignHCenter }
        ...
        Item {
          ...
          ColumnLayout {
            ...
            RowLayout {
              Layout.fillWidth: true
              AtmoIconButton { icon: "chevron-left";  onClicked: calItem.navigate("prev");  Layout.alignment: Qt.AlignVCenter }
              Item { Layout.fillWidth: true }
              ColumnLayout {
              ...
              Item { Layout.fillWidth: true }
              AtmoIconButton { icon: "chevron-right"; onClicked: calItem.navigate("next"); Layout.alignment: Qt.AlignVCenter }
            }
