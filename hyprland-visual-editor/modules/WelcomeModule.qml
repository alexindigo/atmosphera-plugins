...
NScrollView {
    ...
    ColumnLayout {
            ...
            extraContent: ColumnLayout {
                ...
                NBox {
                    ...
                    RowLayout {
                        ...
                        AtmoIcon { icon: "alert-circle"; color: Color.mError; pointSize: Style.fontSizeXL; Layout.alignment: Qt.AlignTop }
                        ColumnLayout {
            ...
            extraContent: ColumnLayout {
                ...
                Repeater {
                    ...
                    delegate: RowLayout {
                        ...
                        AtmoIcon { icon: "check"; color: Color.mPrimary; pointSize: Style.fontSizeM }
        ...
        ProCard {
            ...
            extraContent: ColumnLayout {
                ...
                RowLayout {
                    spacing: Style.marginM
                    AtmoIcon { icon: "code"; color: Color.mOnSurfaceVariant; pointSize: Style.fontSizeL }
                    ColumnLayout {
                        spacing: Style.marginXS
    ...
    component ProCard : NBox {
        ...
        ColumnLayout {
            ...
            RowLayout {
                spacing: Style.marginM
                AtmoIcon { icon: iconName; color: accentColor; pointSize: Style.fontSizeL }
