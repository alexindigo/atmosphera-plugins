                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            AtmoIcon { icon: "plus"; color: tokens.textColor; pointSize: Style.fontSizeM }
                            NText {
                ...
                ListView {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            AtmoIcon { icon: "shield"; color: tokens.textDim; pointSize: Style.fontSizeXXXL; Layout.alignment: Qt.AlignHCenter }
                            NText {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        AtmoIcon { icon: "world"; color: tokens.textDim; pointSize: Style.fontSizeM }
                        NText {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                anchors.centerIn: parent
                                spacing: Style.marginS
                                AtmoIcon { icon: "bolt"; color: tokens.textColor; pointSize: Style.fontSizeM }
            ...
            HCard {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        spacing: Style.marginS
                        AtmoIcon { icon: "filter"; color: tokens.textColor; pointSize: Style.fontSizeM }
