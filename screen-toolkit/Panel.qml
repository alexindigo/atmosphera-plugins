    ...
    Rectangle {
        ...
        Column {
            ...
            Row {
                ...
                AtmoIcon { icon: "crosshair"; color: Color.mPrimary; anchors.verticalCenter: parent.verticalCenter }
            ...
            Rectangle {
                ...
                Row {
                    anchors.centerIn: parent; spacing: Style.marginS
                    AtmoIcon { icon: "loader"; color: Color.mOnSurface; anchors.verticalCenter: parent.verticalCenter
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Row {
                            anchors.centerIn: parent; spacing: Style.marginS
                            AtmoIcon { icon: "device-floppy"; color: recSaveBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; anchors.verticalCenter: parent.verticalCenter }
                            NText {
                    ...
                    Rectangle {
                        ...
                        AtmoIcon { anchors.centerIn: parent; icon: "trash"; color: recDiscardBtn.containsMouse ? Color.mError : Color.mOnSurfaceVariant }
                        MouseArea {
                            id: recDiscardBtn
                            anchors.fill: parent
                            hoverEnabled: true
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Row { anchors.centerIn: parent; spacing: Style.marginXS
                        AtmoIcon { icon: "crop"; color: annotRegionBtn.containsMouse ? Color.mOnPrimary : Color.mPrimary; scale: 0.85 }
                ...
                Rectangle {
                    ...
                    Row { anchors.centerIn: parent; spacing: Style.marginXS
                        AtmoIcon { icon: "maximize"; color: annotFsBtn.containsMouse ? Color.mOnSurface : Color.mOnSurfaceVariant; scale: 0.85 }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Row { id: _scanRow; anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { icon: "scan"; color: scanBtn.containsMouse ? Color.mOnPrimary : Color.mPrimary; scale: 0.8 }
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Row { anchors.centerIn: parent; spacing: Style.marginS
                        AtmoIcon { icon: "crosshair"; color: pinScreenBtn.containsMouse ? Color.mOnPrimary : Color.mPrimary }
                ...
                Rectangle {
                    ...
                    border.color: Style.capsuleBorderColor; border.width: Style.capsuleBorderWidth
                    Row { anchors.centerIn: parent; spacing: Style.marginS
                        AtmoIcon { icon: "folder-open"; color: pinFileBtn.containsMouse ? Color.mOnSurface : Color.mOnSurfaceVariant }
            ...
            Column {
                ...
                Flow {
                    ...
                    Rectangle {
                        ...
                        Row { anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { id: audioOutIcon; icon: root.recordAudioOutput ? "volume" : "volume-off"; color: root.recordAudioOutput ? Color.mOnPrimary : Color.mOnSurface; scale: 0.8 }
                    ...
                    Rectangle {
                        ...
                        Row { anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { id: micIcon; icon: root.recordAudioInput ? "microphone" : "microphone-off"; color: root.recordAudioInput ? Color.mOnPrimary : Color.mOnSurface; scale: 0.8 }
                    ...
                    Rectangle {
                        ...
                        Row { anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { id: cursorIcon; icon: "pointer"; color: root.recordCursor ? Color.mOnPrimary : Color.mOnSurface; scale: 0.8 }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        border.color: Color.mPrimary; border.width: Style.capsuleBorderWidth
                        Row { anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { icon: "crop"; color: recRegionBtn.containsMouse ? Color.mOnPrimary : Color.mPrimary; scale: 0.85 }
                    ...
                    Rectangle {
                        ...
                        border.color: Style.capsuleBorderColor; border.width: Style.capsuleBorderWidth
                        Row { anchors.centerIn: parent; spacing: Style.marginXS
                            AtmoIcon { icon: "maximize"; color: recFsBtn.containsMouse ? Color.mOnSurface : Color.mOnSurfaceVariant; scale: 0.85 }
            ...
            Column {
                ...
                Row {
                    width: parent.width; spacing: Style.marginS
                    AtmoIcon { icon: "camera"; color: Color.mPrimary; anchors.verticalCenter: parent.verticalCenter }
                ...
                Rectangle {
                    ...
                    Row { anchors.centerIn: parent; spacing: Style.marginS
                        AtmoIcon { icon: root.mirrorActive ? "camera-off" : "camera"; color: root.mirrorActive ? Color.mOnError : (mirrorToggleBtn.containsMouse ? Color.mOnPrimary : Color.mPrimary) }
