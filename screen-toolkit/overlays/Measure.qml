    ...
    delegate: PanelWindow {
        ...
        Rectangle {
            ...
            Column {
                ...
                AtmoIcon { icon: "ruler"; color: "white"; anchors.horizontalCenter: parent.horizontalCenter; scale: 2 }
                NText {
        ...
        Rectangle {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    AtmoIcon { anchors.centerIn: parent; icon: "copy"; color: acopyBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; scale: 0.85 }
                ...
                Rectangle {
                    ...
                    AtmoIcon { anchors.centerIn: parent; icon: "camera"; color: ascreenshotBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; scale: 0.85 }
                ...
                Rectangle {
                    ...
                    AtmoIcon { anchors.centerIn: parent; icon: "pin"; color: pinBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; scale: 0.85 }
                ...
                Rectangle {
                    ...
                    AtmoIcon { anchors.centerIn: parent; icon: "x"; color: discardBtn.containsMouse ? Color.mError : Color.mOnSurface; scale: 0.85 }
            ...
            delegate: Rectangle {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        AtmoIcon { anchors.centerIn: parent; icon: "copy"; color: pcopyBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; scale: 0.8 }
                    ...
                    Rectangle {
                        ...
                        AtmoIcon { anchors.centerIn: parent; icon: "camera"; color: pscreenshotBtn.containsMouse ? Color.mOnPrimary : Color.mOnSurface; scale: 0.8 }
                    ...
                    Rectangle {
                        ...
                        AtmoIcon { anchors.centerIn: parent; icon: "x"; color: premoveBtn.containsMouse ? Color.mError : Color.mOnSurface; scale: 0.8 }
        ...
        Rectangle {
            ...
            Row {
                ...
                AtmoIcon { icon: "trash"; color: Color.mError }
