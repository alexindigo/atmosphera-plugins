        ...
        delegate: PanelWindow {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    AtmoIcon { anchors.horizontalCenter: parent.horizontalCenter; icon: "video-off"; color: "white" }
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: root.isSquare ? "arrows-maximize" : "crop"; color: "white" }
                            MouseArea {
                                id: sqHover
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: "flip-horizontal"; color: "white" }
                            MouseArea {
                                id: flipHover
                                anchors.fill: parent; cursorShape: Qt.PointingHandCursor; hoverEnabled: true
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: "camera"; color: "white" }
                            MouseArea {
                                id: shotHover
                                anchors.fill: parent; cursorShape: Qt.PointingHandCursor; hoverEnabled: true
                                onClicked: {
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: root._pinOnShot ? "pin" : "pinned-off"; color: "white" }
                            MouseArea {
                                id: pinToggleMA
                                anchors.fill: parent; cursorShape: Qt.PointingHandCursor; hoverEnabled: true
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: "camera-rotate"; color: "white" }
                            MouseArea {
                                id: camHover
                                anchors.fill: parent; cursorShape: Qt.PointingHandCursor; hoverEnabled: true
                        ...
                        Rectangle {
                            ...
                            AtmoIcon { anchors.centerIn: parent; icon: "x"; color: "white" }
                            MouseArea {
                                id: closeHover
