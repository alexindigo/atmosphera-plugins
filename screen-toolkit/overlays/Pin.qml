                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            AtmoIcon { anchors.horizontalCenter: parent.horizontalCenter; icon: "photo-off"; color: Color.mOnSurfaceVariant }
                        ...
                        Rectangle {
                            ...
                            Row {
                                id: stripRow
                                anchors.centerIn: parent; spacing: Style.marginS
                                AtmoIcon { icon: "brightness-half"; color: Qt.rgba(1,1,1,0.7); scale: 0.8; anchors.verticalCenter: parent.verticalCenter }
                                Item {
                                ...
                                Rectangle {
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    AtmoIcon { anchors.centerIn: parent; scale: 0.8; color: "white"; icon: pinDelegate._playing ? "player-pause" : "player-play" }
                                    MouseArea {
                                ...
                                Rectangle {
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    AtmoIcon { anchors.centerIn: parent; scale: 0.8; color: "white"; icon: pinDelegate._muted ? "volume-off" : "volume" }
                                    MouseArea {
                                ...
                                Rectangle {
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    AtmoIcon { anchors.centerIn: parent; scale: 0.8; icon: "x"; color: "white" }
                                    MouseArea {
                            ...
                            Column {
                                ...
                                component MenuItem: Rectangle {
                                    ...
                                    Row {
                                        ...
                                        AtmoIcon { icon: mIcon;  color: Color.mOnSurface; scale: 0.85; anchors.verticalCenter: parent.verticalCenter }
