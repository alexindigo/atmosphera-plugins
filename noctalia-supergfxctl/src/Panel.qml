...
Item {
    ...
    component GPUButton: Rectangle {
        ...
        RowLayout {
            ...
            // https://github.com/noctalia-dev/noctalia-shell/blob/main/Widgets/AtmoIcon.qml
            AtmoIcon {
    ...
    component Header: NBox {
        ...
        RowLayout {
            ...
            // https://github.com/noctalia-dev/noctalia-shell/blob/main/Widgets/AtmoIconButton.qml
            AtmoIconButton {
