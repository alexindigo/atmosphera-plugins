...
//
// Contracts followed:
//   - docs/specs/plugin-entry-point-contracts.md (AtmoIconButton root, injected
...
AtmoIconButton {
    ...
    // here is equivalent to `this` since `root` is the root `AtmoIconButton`
    // item id.
    //
