...
Item {
    ...
    // MouseAreas (e.g. AtmoIconButton internals). Using it instead of
    ...
    RowLayout {
        ...
        // delete button. The AtmoIcon + inner ColumnLayout mirrors the
        ...
        RowLayout {
            ...
            // disabled so AtmoIcon (and any other child with hover/mouse
    ...
    // MouseArea instead of TapHandler: AtmoIconButton's internal MouseArea has
    ...
    // and plays correctly with AtmoIconButton's own handler sitting above it.
    //
    // anchors.fill covers the full row; the delete button's own MouseArea
    // (inside AtmoIconButton) sits higher in the z-order and handles its own
